 ...
 * @private
 */
// [HS] REMOVE EAGER INIT UNTIL IT REALLY NEEDS IT TO ALLOW REWRITER INJECT DEFAULT USER PREFS
os.gadgetPrefs_ = null;
os.getGadgetUserPrefs = function() {
  if (os.gadgetPrefs_ !== null) {
    return os.gadgetPrefs;
  }
...
os.getPrefMessage = function(key) {
  // [HS] cal internal function for user pref
  var osGadgetPrefs = os.getGadgetUserPrefs();
  return osGadgetPrefs.getMsg(key);
};
