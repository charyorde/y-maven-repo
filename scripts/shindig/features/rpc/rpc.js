...
if (!window['gadgets']['rpc']) { // make lib resilient to double-inclusion
  ...
  gadgets.rpc = function() {
    ...
    // [HS] Add check for container inside an iframe by checking "parent" url parameter
    var isChild = !!gadgets.util.getUrlParameters().parent && (window.top !== window.self);
    ...
    function callSameDomain(target, rpc) {
     ...
     if (!sameDomain[target] || sameDomain[target].sameDomain || (sameDomain[target] !== _flagCrossOrigin &&
