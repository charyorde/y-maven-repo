...
(function() {
  ...
  function ActionRegistry() {
    ...
    this.getAllActions = function() {
      var actions = [];
      for (var actionId in this.registryById) {
    ...
    /**
     * [hsaputra] Add fix to make sure it iterates trhough array and not up to protoype chain.
     *
        ...
        if (metadata.modulePrefs) {
          ...
          if (feature && feature.params) {
            ...
            if (desc) {
              ...
              // [HS] JIVE-14832 Fix the action-contributions content to pass some DOM parsers like IE7
              // TODO: Fix this in Shindig trunk
              ...
              // [HS] Lets check if we have <actions>
              if (desc.indexOf("<actions>") === -1) {
              ...
              if (domResponse && !domResponse['errors']) {
                ...
                if (actionsJson) {
                  ...
                  for (var i = 0; i < actions.length; i++) {
                    ...
                    for (var itemAttr in actionObj) {
                      if(!actionObj.hasOwnProperty(itemAttr)) {
                          continue;
                      }
  ...
  var showActionHandlerProxy = function(actions) {
    ...
    for (var i = 0; i < showActionListeners.length; i++) {
  ...
  var hideActionHandlerProxy = function(actions) {
    ...
    for (var i = 0; i < hideActionListeners.length; i++) {
