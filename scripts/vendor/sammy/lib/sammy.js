...
(function(){
  ...
  this.SammyClass = function(){};
  SammyClass.extend = function(prop) {
    ...
    SammyClass.prototype = prototype;
    SammyClass.constructor = SammyClass;
    SammyClass.extend = arguments.callee;   
    return SammyClass;
  };
})();
...
(function($) {
  ...
  Sammy.Object = SammyClass.extend({
  ...
  Sammy.Application = Sammy.Object.extend({
    ...
    route: function(verb, path, callback) {
      ...
      if (path.constructor == String) {
        ...
        param_names = (path.match(PATH_NAME_MATCHER) || []);
        for (i = 0; i < param_names.length; i += 1) {
