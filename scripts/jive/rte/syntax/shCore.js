...
dp.sh.HighlightAll = function(name, showGutter /* optional */, showControls /* optional */, collapseAll /* optional */, firstLine /* optional */, showColumns /* optional */)
{
	...
	{
		dp.sh.Highlight.apply(dp.sh, [elements[i]].concat(options));
	}
};

// highlights the given element and gets source code from the specified
// property
dp.sh.Highlight = function(element, showGutter /* optional */, showControls /* optional */, collapseAll /* optional */, firstLine /* optional */, showColumns /* optional */)
{
	...
	function InjectBrushStyle(highlighter)
	{
	...
	var highlighter;
	var registered = RegisterBrushes();
	...
	highlighter.noGutter = typeof showGutter == 'undefined' ? IsOptionSet('nogutter', options) : !showGutter;
	highlighter.addControls = typeof showControls == 'undefined' ? !IsOptionSet('nocontrols', options) : showControls;
	highlighter.collapse = typeof collapseAll == 'undefined' ? IsOptionSet('collapse', options) : collapseAll;
	highlighter.showColumns = typeof showColumns == 'undefined' ? IsOptionSet('showcolumns', options) : showColumns;

	if (!dp.sh.InjectedStyles[language]) {
		InjectBrushStyle(highlighter);
		dp.sh.InjectedStyles[language] = true;
	}
	
	// first line idea comes from Andrew Collington, thanks!
	highlighter.firstLine = typeof firstLine == 'undefined' ? parseInt(GetOptionValue('firstline', options, 1), 10) : firstLine;
