...
jive.namespace('Places').SpacesController = {
  ...
  initialize: function(options) {
    ...
    //getUserSpaces = model.getUserSpaces.bind(model, placeType +"s");
    getUserSpaces = model.getUserSpaces.bind(model);
    ...
    function requestData() {
      ...
      getUserSpaces().addCallback(displayData);
    }
