 ...
 */
jive.RestService = jive.oo.Class.extend(function(protect) {
    var $ = jQuery;
     ...
     * @param {jive.conc.Promise} promise, pre-initialized promise object
     ...
     * @returns {jive.conc.Promise} promise that is fulfilled when the resource is successfully sent
     * @protected
     */
    ...
    this.save = function(resource) {
        ...
        return this.commonAjaxRequest(new jive.conc.Promise(), method, {
            url: url,
    ...
    this.findAll = function(params) {
        ...
        return this.commonAjaxRequest(new jive.conc.Promise(), 'GET', {url:url, data:data});
    };
...
//                }
    ...
    protect.maybeEmitError = function(promise, genericError, args) {
        ...
        promise.emitError.apply(promise, args);
    };
...
define('jive.RestService', function() {
    return jive.RestService;
});
