 ...
 * @config {string} objectType The type of content to create that we need a container for
 ...
 */
jive.PublishBar.SuggestedContainersSource = jive.RestService.extend(function(protect, _super) {
