 ...
 */
jive.namespace('RecommendationApp').RecommendedForYouController = function(model, $container) {
    ...
    function loadRecommendations(data) {
        controller.getBody().html(jive.eae.recommendation.recommendedForYou({ recommendations: data}));
