 ...
 * Build: http://www.modernizr.com/download/#-csstransforms-csstransforms3d-draganddrop-hashchange-history-localstorage-postmessage-shiv-addtest-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-file_api-load
 */
;
        ...
        injectElementWithStyles(style, function( node, rule ) {
            ...
            while ( len-- ) {
                hash[children[len].id] = children[len];
                     ...
                     Modernizr['csstransforms3d'] = (hash['csstransforms3d'] && hash['csstransforms3d'].offsetLeft) === 9 && hash['csstransforms3d'].offsetHeight === 3;                              }, len, tests);
