...
JsMockito.mockFunction = function(funcName, delegate) {
  ...
  var mockFunc = function() {
    ...
    var matches = stubMatchers.filter(function(stubMatcher) {
    ...
    matches.forEach(function(match) {
      ...
      stubs.forEach(function(stub) {
        var stubRet = stub.apply(self, mockArgs);
        ret = (typeof stubRet == 'undefined') ? ret : stubRet;
      });
    });

    // Returns the return value of the last stub that has a return
    // value.
    return ret;
  };
